    ...
    >
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between gap-x-9 items-center '>
        ...
        <div className='text-1 md:w-1/2 text-center md:text-left mt-8 md:mt-0'>
          ...
          {/* about me paragraph  */}
          <p className='overflow-hidden text-2 gpu-boost text-sm sm:text-md md:text-md text-gray-400 mt-8 leading-relaxed whitespace-pre-line'>
            {personalInfo.about}
          </p>
          {/* resume button*/}
          <a
        ...
        <div className='md:w-1/2 flex justify-center mt-8 md:mt-0'>
          <div className='imgCard relative z-1'>
            <Tilt
              ...
              <img src={profile} alt='Aviral Trivedi'
